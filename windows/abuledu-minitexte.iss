...
Source: "..\data\*.abe"; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "..\data\icones\abuledu-minitexte-128.png"; DestDir: "{app}"; Flags: ignoreversion
